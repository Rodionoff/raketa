<template>
  <div class="App-logo">
    <svg
      ...
      x="0px"
      y="0px"
      viewBox="0 0 501.85 501.85"
      style="enable-background:new 0 0 501.85 501.85;"
      xml:space="preserve"
    >
      <!-- fire start -->
      <path
        style="fill:#F8B64C;"
        d="M344.967,307.35l-38.661-1.045l1.045,38.661c1.045,62.694,53.29,113.894,115.984,115.984
l38.661,1.045l-1.045-38.661C458.86,360.64,407.66,308.395,344.967,307.35z"
      ></path>
      <path
        style="fill:#FFD15C;"
        d="M355.416,328.248l-27.167-1.045l1.045,27.167c1.045,44.931,38.661,82.547,83.592,83.592l27.167,1.045
l-1.045-27.167C437.963,366.909,400.346,329.293,355.416,328.248z"
      ></path>
      <!-- fire end -->
      <path
        style="fill:#FF7058;"
        d="M501.701,304.215c-5.224-9.404-12.539-17.763-19.853-25.078
...
c42.841,6.269,84.637,25.078,117.029,58.514C483.938,193.456,503.791,249.881,501.701,304.215z"
      ...
      <path
        style="fill:#F2F2F2;"
        d="M411.84,305.26C382.583,126.583,228.983-5.074,38.811,0.15L1.195,1.195L0.15,38.811
C-5.074,228.983,126.583,382.583,305.26,411.84L411.84,305.26z"
      ></path>
      <g>
        <path
          style="fill:#40596B;"
          d="M223.758,388.852c26.122,10.449,53.29,17.763,81.502,22.988l105.535-105.535
c-4.18-28.212-12.539-55.38-22.988-81.502L223.758,388.852z"
        ></path>
        <path
          style="fill:#40596B;"
          d="M163.154,16.869C124.493,5.375,82.697-0.895,38.811,0.15L1.195,1.195L0.15,38.811
c-1.045,43.886,5.224,85.682,16.718,124.343L163.154,16.869z"
        ></path>
      </g>
      <path
        style="fill:#F2F2F2;"
        d="M305.26,411.84c10.449,2.09,21.943,3.135,32.392,4.18l77.322-77.322
c-1.045-11.494-2.09-21.943-4.18-32.392L305.26,411.84z"
      ></path>
      <ellipse style="fill:#40596B;" cx="174.515" cy="174.962" rx="80.456" ry="80.456"></ellipse>
      <ellipse style="fill:#84DBFF;" cx="174.515" cy="174.962" rx="56.424" ry="56.424"></ellipse>
      <path
        style="fill:#54C0EB;"
        d="M139.122,147.481c19.853-19.853,51.2-19.853,71.053,0c18.808,18.808,19.853,49.11,2.09,68.963
...
<style lang='sass'>
.App-logo
  animation: fly infinite 5s ease
  height: 10vh
  width: 10vh
  max-height: 100px
  max-width: 100px
...
@keyframes fly
  ...
  100%
    transform: translateX(70vw) rotate(135deg)

.App-logo svg > path:nth-child(1)
  animation: fire infinite 2s linear

.App-logo svg > path:nth-child(2)
  fill: #FFD15C
